    ...
    return new Promise(async (resolve) => {
        try {
            ...
            if (solaxRequest.data && solaxRequest.data.Data) {
                ...
                await adapter.setStateAsync('total.energy', solaxRequest.data.Data[68], true);
                await adapter.setStateAsync('total.energyResets', solaxRequest.data.Data[69], true);
                await adapter.setStateAsync('total.batteryDischargeEnergy', div10(solaxRequest.data.Data[74]), true);
                await adapter.setStateAsync('total.batteryDischargeEnergyResets', solaxRequest.data.Data[75], true);
                await adapter.setStateAsync('total.batteryChargeEnergy', div10(solaxRequest.data.Data[76]), true);
                ...
                await adapter.setStateAsync('total.pvEnergy', div10(solaxRequest.data.Data[80]), true);
                await adapter.setStateAsync('total.pvEnergyResets', div10(solaxRequest.data.Data[81]), true);
                await adapter.setStateAsync('todays.energy', div10(solaxRequest.data.Data[82]), true);
                await adapter.setStateAsync('total.consumption', div100(solaxRequest.data.Data[88]), true);
